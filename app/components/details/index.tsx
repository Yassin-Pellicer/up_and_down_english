...
import { Carousel } from "../carousel/pics";
...
export function Details() {
  ...
  const otherVideos = t('details_three.carousel', { returnObjects: true }) as Array<{ link: string; img: string }>;
  ...
  return (
    <div className="grid gap-4 sm:py-32 pb-24">
      ...
      <section className="flex flex-col gap-4 align-center w-full text-black text-shadow-xl" >
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 md:gap-12 gap-6 sm:my-12 my-6">
          {methods.map((method, index) => (
            <div key={index} className="select-none flex justify-center px-6 py-4 rounded-2xl border-2 border-[#c8aacf] shadow-lg hover:shadow-xl flex-col gap-4 transition duration-75">
              <p className="flex flex-row items-center text-2xl font-bold border-b-2 pb-4 border-black">
      ...
      <section className="flex flex-col align-center w-full text-black text-shadow-xl" >

        <h1 className="xl:text-6xl mb-12 md:text-5xl text-4xl font-bold tracking-tighter">
          <Trans
        ...
        <div className="md:grid flex w-fit md:grid-cols-[auto_60%] flex-col-reverse items-center justify-between sm:gap-12 gap-6 auto-cols-fr">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Carousel items={otherVideos}></Carousel>
            </div>
            ...
            <div className="flex justify-between text-white! bg-gray-200 rounded-2xl">
              <button
            ...
            <div className="border-t sm:py-6 pt-6 pb-0 sm:mt-6 mt-3 border-black">
